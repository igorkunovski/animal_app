...
public class ConsoleView {
    ...
    public static void showMainMenu(){
        ...
        System.out.println(" 3. Show all Animal commands");
        System.out.println(" 4. Teach Animal a new command");
        System.out.println(" 5. Remove Animal from collection");
        System.out.println(" 6. Show only certain type of Animal from collection");
        System.out.println(" 7. Show Animal all possible data");
